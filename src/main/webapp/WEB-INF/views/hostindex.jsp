								...
								<div class="item">
									<div class="work-wrap d-md-flex">
										...
										<div class="text text-left d-flex align-items-center setaddcha">
											...
											<input class="setaddress" type="text" name="address" id="inputaddress"
							...
							<div class="mySlides ">
								<div class="item">
									<div class="work-wrap d-md-flex">
										<div class="img chaadd order-md-last"
											 style="background-image: linear-gradient(to top right, blue, pink);">
											<h2 class="address">Bạn muốn chào đón bao nhiêu phòng cho thuê?</h2>
										</div>
										<div
												class="text text-left  p-4 px-xl-5 d-flex align-items-center">
											<div class="py-md-5">
												<table class="bnkhach">
													<tr>
														<td><b>Khách </b></td>
														<td><input type="number" name="numberPlace" value="1"
																   placeholder="Vui lòng nhập số phòng cho thuê" /></td>
													</tr>
												</table>
											</div>
										</div>
									...
									<div class="work-wrap d-md-flex">
										...
										<div
											...
											<div class="py-md-5">
												...
												<br>
												<textarea name="detail" rows="4" cols="60" class="ftd" maxlength="500" id="content"
