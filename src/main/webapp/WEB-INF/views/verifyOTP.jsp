                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5 col-md-7  d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form class="form" method="post" action="/verify-otp">
                                    <div class="col-50">
                                        <h3>Nhập mã xác nhận</h3><br>
                                    ...
                                    <p><a href="/search-account?email=${email}">Chưa nhận được mã?</a></p>
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Gửi</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-2 text-sm mx-auto">
                                    Bạn đã có tài khoản?
                                    <a href="../pages/sign-in.html" class="text-primary text-gradient font-weight-bold">Đăng nhập</a>
                                </p>
                            </div>
                        </div>
                    </div>
