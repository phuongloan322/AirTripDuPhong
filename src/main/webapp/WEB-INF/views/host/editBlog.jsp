...
<div class="about wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="table-responsive cart_info" >
            <div class="border">
                <form style="margin: 50px 100px" method="post" enctype="multipart/form-data">
                    <h5><b>Chỉnh sửa bài Blog</b></h5><br>
                    ...
                    <div>
                        <button onclick="return validate()" class="btn btn-primary float-lg-right" style="background: #ef4365;border: none;">Cập nhật bài viết</button>
                    </div>
                    <br>
                </form>
            </div>
