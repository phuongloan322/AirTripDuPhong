            ...
            <div class="col-lg-8">
                ...
                <div class="single-bio wow fadeInUp">
                    ...
                    <div class="single-bio-text" style="padding-left: 0px !important;">
                        ...
                        <p>Bắt đầu tham gia vào tháng ${blog.account.createDate.split("-")[1]}
                            năm ${blog.account.createDate.split("-")[0]}</p>
                    </div>
                </div>
                ...
                <div class="sidebar">
                    <div class="sidebar-widget wow fadeInUp">
                        <div class="search-widget">
                            <form action="/blog">
                                <input class="form-control" type="text" placeholder="Search Keyword" name="search">
